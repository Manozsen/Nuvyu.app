...
function BentoCard({ icon: Icon, label, value, target, color, delay }: { icon: any, label: string, value: any, target: string, color: string, delay: number }) {
  return (
    <motion.div 
